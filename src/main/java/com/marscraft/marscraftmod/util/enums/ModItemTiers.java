package com.marscraft.marscraftmod.util.enums;
...
public enum ModItemTiers implements IItemTier {
	...
	TITANIUM(4, 2347, 14.0F, 3.0F, 30, () -> {
		return Ingredient.fromItems(ItemInit.TITANIUM_INGOT.get());
	}),
	
	OSMIUM(3, 1561, 10.0F, 3.0F, 25, () -> {
		return Ingredient.fromItems(ItemInit.OSMIUM_INGOT.get());
	});
