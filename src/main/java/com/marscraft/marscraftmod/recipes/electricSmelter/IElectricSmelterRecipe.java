...
public interface IElectricSmelterRecipe extends IRecipe<RecipeWrapper> {
	ResourceLocation RECIPE_TYPE_ID = new ResourceLocation(MarsCraftMod.MOD_ID, "electric_smelter");
